...
// In a Blazor WASM hosted application, the client and server are served from the same origin
// So we can use the host environment base address which will work in all environments
